...
Som nämnts i föregående avsnitt kan du lägga till både interaktivt och statiskt innehåll i biblioteket.
...
1. Learning Manager stöder bildtexter för videoinnehåll som laddats upp i Learning Manager. Nu kan användarna ladda upp filen som innehåller bildtexter tillsammans med videofilen.
   ...
   Det format som stöds är  [Textspår för webbvideo (webVTT)](https://www.w3.org/TR/webvtt1/).
...
1. Ange de poäng som du vill skicka frågeformuläret med i **Kriterier för godkänt** område.
1. Om du vill att en elev ska se ett korrekt svar aktiverar du växlingsknappen **Visa korrekta svar** till elever efter frågeformuläret.
...
1. I dialogrutan **Varaktighet** anger du den tid som eleven måste lägga på frågeformuläret.
...
<table>
 <tbody>
  ...
  <tr>
   <td>
    <p>Du kan bara ställa in <b>Slutförande</b> Kriterier för innehållet för följande alternativ:</p>
    <ul>
     <li>Vid inläsning av innehåll</li>
     <li>Baserat på den lägsta andelen som krävs</li>
    </ul></td>
   <td>
    <p>Du kan ange båda <b>Slutförande</b> och <b>Slutfört</b> kriterier för innehållet i följande alternativ:</p>
    <ul>
     <li>Vid inläsning av innehåll</li>
     <li>Baserat på den lägsta andelen som krävs</li>
     <li>Alternativ för godkänt eller försökt quiz</li>
    </ul>
    <p><b>OBS!</b> Det är bara HTML-innehåll från Captivate, Presenter Video Express eller Presenter som kan redigeras.</p></td>
  </tr>
 </tbody>
</table>
