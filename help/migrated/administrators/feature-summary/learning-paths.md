...
Elever kan registreras till en kurs genom en utbildningsplan eller av en administratör, även om kursen är flexibel och kräver att eleven väljer en session. I dessa fall tillåter systemet elever att registrera sig även om platsbegränsningen har uppnåtts, men de kan inte starta kursen förrän en plats blir tillgänglig.

Väntelistefunktionen gäller endast när elever registrerar sig själva. När en session når sin platsgräns kan instruktören visa listan med elever på väntelistan. Om platser blir tillgängliga kan instruktören lägga till elever på väntelistan tills sessionen når kapacitet igen.
