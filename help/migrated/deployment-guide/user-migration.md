---
description: Definiera och konfigurera ett identitetssystem som slutanvändarna autentiseras mot.
jcr-language: en_us
...
Klicka på **[!UICONTROL ** Begäran om CSV FTP-mapp **på startsidan för Integreringsadministratör.]** Ange e-post-ID i popup-dialogrutan som visas. Gå igenom onlineguiden för att skapa FTP-kontot för Exavault. När du har skapat ditt konto kan du visa migreringsprojektet och sprintprojektmapparna i Exavault FTP.
